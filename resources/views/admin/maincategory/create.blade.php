                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('maincat.store')}}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            @foreach (get_languages() as $index=> $langs)
                                                
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput1">اسم القسم {{__('messages.' . $langs->abbr)}}</label>
                                                ...
                                                <div class="col-md-6 hidden">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> الاختصار  {{__('messages.' . $langs->abbr)}}</label>
                                                    <input type="text" value="{{$langs->abbr}}" id="name"
                                                               class="form-control"
                                                               placeholder="مثال ar"
