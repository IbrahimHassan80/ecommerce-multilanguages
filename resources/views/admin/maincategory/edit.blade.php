                            ...
                            <div class="card-content collapse show">
                                ...
                                <form class="form" action="{{route('admin.update.main_cat',$category->id)}}" method="post"
                                    ...
                                    <ul class="nav nav-tabs">                                            
                                        ...
                                        aria-expanded="true">{{$lang->translation_lang}}</a>
                                        </li>
                                        @endforeach
                                        @endisset
                                      </ul>
                                      ...
                                      <div class="tab-content px-1 pt-1">
                                       <div role="tabpanel" class="tab-pane" id="homeLable{{$index}}"
                                        ...
                                        <form class="form" action="{{route('admin.update.main_cat',$lang->id)}}" method="post"
                                            enctype="multipart/form-data">
                                          @csrf
                                          <input type="hidden" name="id" value="{{$lang->id}}">
                                           <div class="form-body">
                                              ...
                                              <div class="row">
                                                  <div class="col-md-12">
                                                      <div class="form-group">
                                                          <label for="projectinput1">اسم القسم {{__('messages.' . $lang->translation_lang)}}</label>
                                                  ...
                                                  <div class="col-md-6 hidden">
                                                      <div class="form-group">
                                                          <label for="projectinput1"> الاختصار  {{__('messages.' . $lang->translation_lang)}}</label>
                                                      <input type="text" value="{{$lang->translation_lang}}" id="name"
                                                                 class="form-control"
                                                                 placeholder="مثال ar"
                                                                 name="category[0][abbr]">
                                                                 @error("category.0.abbr")
                                                      ...
                                                      <div class="form-group mt-1">
                                                          <input type="checkbox"  value="1" name="category[0][active]"
                                                                 ...
                                                                 class="switchery" data-color="success"
                                                                  @if($category->active == 1) checked @endif/>
                                                          <label for="switcheryColor4"
                                                                 class="card-title ml-1">الحالة {{__('messages.' . $lang->translation_lang)}}</label>
